...
def _load_curve(series_dir: str, seed: int) -> np.ndarray:
    ...
    """
    if series_dir == "Result_1Number/mutli_agent/120":
...
series = [
    {"dir": "Result_1Number/LLM/120", "label": "LLM+DE"},
    {"dir": "Result_1Number/DE/120", "label": "All_DE"},
    {"dir": "Result_1Number/GA/120", "label": "All_GA"},
    # {"dir": "Result_random", "label": "Random"},
    # {"dir": "Result_Closest", "label": "Closest"},
    {"dir": "Result_1Number/mutli_agent/120", "label": "Multi_Agent"},
]
