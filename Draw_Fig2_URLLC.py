...
user_num_LLM = [0.03, 1.0527,1.06794,1.0879, 1.1101]
...
with plt.style.context("ieee"):
    ...
    plt.ylabel("Outage ratio of delay-sensitive user",fontsize=size_yxlim)
    ...
    plt.tight_layout()
    plt.savefig("Fig_journal/Fig2_urllc.pdf", dpi=300)